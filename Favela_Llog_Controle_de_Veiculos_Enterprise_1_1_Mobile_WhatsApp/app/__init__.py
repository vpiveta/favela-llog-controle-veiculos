...
def create_app():
    ...
    from .checklist_retroactive_hotfix import init_checklist_retroactive_hotfix
    init_checklist_retroactive_hotfix(app)
    ...
    with app.app_context():
        ...
        try:
            ...
            migrations = {
                ...
                'maintenance_detail': [('is_oil_change','BOOLEAN NOT NULL DEFAULT FALSE'), ('oil_amount','NUMERIC(12,2)'), ('maintenance_type','VARCHAR(120)'), ('labor_amount','NUMERIC(12,2)'), ('parts_description','TEXT')],
